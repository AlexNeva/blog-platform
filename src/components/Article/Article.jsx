...
function Article({ title, author, createdAt, tags, descr, favorited, likes, slug, edit, children }) {
        ...
        <div className={classes.Author}>
          <div className={classes.AuthorInfo}>
            ...
            <div className={classes.AuthorDate}>
              ...
              {moment(createdAt).utc().format('MMMM D,yy')}
            </div>
          </div>
